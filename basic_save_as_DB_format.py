...
def result_data(file):
    ...
    for y in range(1, z+1):
        ...
        # print(result['product_description'+a])

    for x in range(z+1, 11):
        a = str(x)
        result['product_description'+a]='-'
        result['quantity'+a]='-'
        result['net_price'+a]='-' 
        result['amount'+a]='-'
        # print(result['product_description'+a])    

        # if data['description '+b] is not None:
        #     result['product_description'+a]=data['description '+b]    
        # else:            
        #     result['product_description'+a]='-'
        # print(result['product_description'+a])                
        # if data['Order quantity '+b] is not None:
        #     result['quantity'+a]=data['Order quantity '+b]
        # else:
        #     result['quantity'+a]='-'
        # if data['Net unit price '+b] is not None:
        #     result['net_price'+a]=data['Net unit price '+b]
        # else:
        #     result['net_price'+a]='-'            
        # if data['Amount '+b] is not None:
        #     result['amount'+a]=data['Amount '+b]            
        # else:
        #     result['amount'+a]='-'
